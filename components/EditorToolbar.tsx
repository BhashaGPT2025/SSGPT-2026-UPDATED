...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({ onInsertImage }) => {
    ...
    return (
        <div className="flex flex-wrap items-center justify-center gap-1 p-2 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-20 shadow-sm select-none">
